...
var _prices__slider = __webpack_require__(7);

var _prices__slider2 = _interopRequireDefault(_prices__slider);
...
var _HeroSlider = __webpack_require__(10);
...
new _RevealOnScroll2.default((0, _jquery2.default)(".prices"), "85%");
var mobileMenu = new _MobileMenu2.default();
var stickyHeader = new _StickyHeader2.default();
var priceslider = new _prices__slider2.default();
var modal = new _Modal2.default();
var info = new _Info2.default();
var slider = new _HeroSlider2.default();
...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.siteHeader = (0, _jquery2.default)(".site-header");
        this.headerTriggerElement = (0, _jquery2.default)(".video__content");
        this.headerText = (0, _jquery2.default)(".site-header__addtext");
        this.createHeaderWaypoint();
        this.pageSections = (0, _jquery2.default)(".page-section");
        this.headerLinks = (0, _jquery2.default)(".primary-nav a");
        this.createPageSectionWaypoints();
        this.bottomArrow = (0, _jquery2.default)(".arrow a");
...
var prices__slider = function () {
    function prices__slider() {
        _classCallCheck(this, prices__slider);

        this.nextSliderButton = (0, _jquery2.default)(".prices__next");
        this.sliderImg = (0, _jquery2.default)(".prices__inner img");
        this.prevSliderButton = (0, _jquery2.default)(".prices__prev");
        this.events();
    }

    _createClass(prices__slider, [{
        key: "events",
        value: function events() {
            this.nextSliderButton.click(this.nextIMG.bind(this));
            this.prevSliderButton.click(this.prevImg.bind(this));
        }
    }, {
        key: "nextIMG",
        value: function nextIMG() {
            this.sliderImg.addClass("prices__inner img--visible");
            return false;
        }
    }, {
        key: "prevImg",
        value: function prevImg() {
            this.sliderImg.removeClass("prices__inner img--visible");
        }
    }]);

    return prices__slider;
}();

exports.default = prices__slider;
...
var Info = function () {
  function Info() {
    ...
    this.pricesInfo = (0, _jquery2.default)(".info__content");
    this.infoIcon = (0, _jquery2.default)(".info__menu-icon");
    this.events();
  }
